...
class Producer:
    ...
    def purge(
        self, in_queue: bool = True, in_flight: bool = True, blocking: bool = True
    ) -> None: ...
...
class Consumer:
    ...
    def consume(
        self, num_messages: int = 1, timeout: float | int = -1
    ) -> list[Message]: ...
    ...
    def list_topics(
        self, topics: str | None = None, timeout: float | int = -1
    ) -> ClusterMetadata: ...
...
class Uuid:
    ...
    def __hash__(self) -> int: ...
    def __init__(
        self, most_significant_bits: int, least_significant_bits: int
    ) -> None: ...
