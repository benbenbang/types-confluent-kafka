...
class KafkaError:
    ...
    def __eq__(self, other: "KafkaError") -> bool: ...
    ...
    def __ne__(self, other: "KafkaError") -> bool: ...
...
class _AdminClientImpl:
    ...
    def alter_configs(self) -> Any: ...
    def alter_consumer_group_offsets(self) -> Any: ...
    def alter_user_scram_credentials(self) -> Any: ...
    def create_acls(self) -> Any: ...
    def create_partitions(self) -> Any: ...
    def create_topics(self) -> Any: ...
    def delete_acls(self) -> Any: ...
    def delete_consumer_groups(self) -> Any: ...
    def delete_topics(self) -> Any: ...
    def describe_acls(self) -> Any: ...
    def describe_configs(self) -> Any: ...
    def describe_consumer_groups(self) -> Any: ...
    def describe_user_scram_credentials(self) -> Any: ...
    def incremental_alter_configs(self) -> Any: ...
    def list_consumer_group_offsets(self) -> Any: ...
    def list_consumer_groups(self) -> Any: ...
...
class Consumer:
    ...
    def list_topics(self, topics: str | None = None, timeout: float | int = -1) -> Any: ...
    def memberid(self) -> str | None: ...
    def offsets_for_times(
        self, partitions: list[TopicPartition], timeout: float | int | None = None
    ) -> list[TopicPartition]: ...
    def pause(self, partitions: list[TopicPartition]) -> None: ...
    def poll(self, poll: float | int | None) -> Message | None: ...
