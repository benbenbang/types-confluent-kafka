...
class ConsumerGroupMetadata:
    ...
    Note: https://docs.confluent.io/platform/current/clients/confluent-kafka-python/html/index.html#id6
    """
...
class Consumer:
    ...
    def consumer_group_metadata(self) -> ConsumerGroupMetadata: ...
