...
class Serializer:
    def __call__(self, obj: object | None, ctx: SerializationContext | None = None) -> bytes | None: ...

class Deserializer:
    def __call__(self, value: bytes | None, ctx: SerializationContext | None = None) -> object | None: ...
